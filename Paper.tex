...
\addbibresource{/GD/LMBD/Papers/2015MolBioSense/references.bib}
\usepackage{enumitem}
...
\hline 
\textbf{Pheromone} & \textbf{Range} & \textbf{emitter -> detector} & \textbf{Receptor} & \textbf{PN} & \textbf{Behavior} & \textbf{Comments} & \textbf{Refs}\tabularnewline
\hline 
\hline 
